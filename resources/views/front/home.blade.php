...
<body>
            ...
            <div class="carousel-item active view hm-black-light" style="background-image: url('images/Banner/bannercomida1.png'); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="full-bg-img flex-center white-text">
                    <ul class="animated fadeIn col-md-12">
                        ...
                        <li>
                            <p>El mejor restaurante de comida en todo México, Kanto, Ciudad Gótica, Asia y Júpiter.</p>
                        </li>
                        <li>
                            <a target="_blank" href="https://mdbootstrap.com/getting-started/" style="background:#ff8c00" class="btn btn-info btn-lg" rel="nofollow">Éntrele!</a>
                        </li>
                    </ul>
                </div>
                <!-- /.Caption -->
            ...
            <div class="carousel-item view hm-black-light" style="background-image: url('images/Banner/bannercomida2.png'); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="full-bg-img flex-center white-text">
                    <ul class="animated fadeIn col-md-12">
                        ...
                        <li>
                            <a target="_blank" href="https://mdbootstrap.com/bootstrap-tutorial/" style="background:#ff8c00" class="btn btn-info btn-lg" rel="nofollow">Éntrele!</a>
                        </li>
                    </ul>
                </div>
                <!-- /.Caption -->
            ...
            <div class="carousel-item view hm-black-light" style="background-image: url('images/Banner/bannercomida3.png'); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="full-bg-img flex-center white-text">
                    <ul class="animated fadeIn col-md-12">
                        ...
                        <li>
                            <a target="_blank" href="https://mdbootstrap.com/forums/forum/support/" style="background:#ff8c00" class="btn btn-default btn-lg" rel="nofollow">Éntrele!</a>
                        </li>
                    </ul>
                </div>
                <!-- /.Caption -->
    ...
    @foreach($categorias as $categ)
        ...
        <div class="row my-5">
            ...
            <div class="col-lg-4">
                <!--Card-->
                <div class="card wow fadeIn" data-wow-delay="0.2s" style="height:480px!important;margin-bottom:5%">
                    ...
                    <div class="card-body">
                        ...
                        <!--Text-->
                        <p class="card-text">{{ $elemen->descripcion }}</p>
                        <a href="#" style="background:#ff8c00" class="btn btn-info">{{ $elemen->precio }}</a>
                    </div>
